...
st.title('Phishing  Detection system using Machine Learning')
st.write('This ML-based app is developed as a project for the depertment of computer science chukwuemeka odumegwu ojukwu university uli campus. Objective of the app is detecting phishing websites only using content data. Not URL!'
